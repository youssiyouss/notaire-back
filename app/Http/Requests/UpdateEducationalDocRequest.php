...
class UpdateEducationalDocRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'file_path.required' => 'Le fichier du PDF est requis.',
            'audience.required' => 'Veuillez sélectionner le public cible de ce fichier',
            'file_path.mimes' => 'Le fichier doit être un PDF.',
            'file_path.max' => 'Le PDF ne doit pas dépasser 4 Mo.',
        ];
    }
}
